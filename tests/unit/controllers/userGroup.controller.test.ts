...
import { assignUsersToGroup, removeUsersFromGroup, getGroupUsers, getUserGroups } from '../../../src/controllers/userGroup.controller';
...
describe('UserGroup Controller', () => {
  ...
  describe('assignUsersToGroup', () => {
    it('should successfully assign users to group', async () => {
      const mockResult = {
        ...
        skipped: 0,
        details: [
          { userId: 1, username: 'user1', email: 'user1@test.com', status: 'assigned' as const },
          { userId: 2, username: 'user2', email: 'user2@test.com', status: 'assigned' as const }
        ]
      };
      ...
      await assignUsersToGroup(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('removeUsersFromGroup', () => {
    it('should successfully remove users from group', async () => {
      const mockResult = {
        ...
        notFound: 0,
        details: [
          { userId: 1, username: 'user1', email: 'user1@test.com', status: 'removed' as const },
          { userId: 2, username: 'user2', email: 'user2@test.com', status: 'removed' as const }
        ]
      };
      ...
      await removeUsersFromGroup(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('getGroupUsers', () => {
    it('should successfully get group users', async () => {
      ...
      mockUserGroupServiceInstance.getGroupUsers.mockResolvedValue(mockUsers as any);

      await getGroupUsers(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('getUserGroups', () => {
    it('should successfully get user groups', async () => {
      ...
      mockUserGroupServiceInstance.getUserGroups.mockResolvedValue(mockGroups as any);

      await getUserGroups(mockRequest as Request, mockResponse as Response, mockNext);
