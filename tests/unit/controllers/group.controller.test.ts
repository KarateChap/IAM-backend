...
import { groupService, auditService } from '../../../src/services';
...
describe('Group Controller', () => {
  ...
  describe('getAll', () => {
    it('should successfully get groups with default filters', async () => {
      ...
      await groupController.getAll(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('getById', () => {
    it('should successfully get group by id', async () => {
      ...
      await groupController.getById(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('create', () => {
    it('should successfully create a group', async () => {
      ...
      await groupController.create(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('update', () => {
    it('should successfully update a group', async () => {
      ...
      await groupController.update(mockRequest as Request, mockResponse as Response, mockNext);
  ...
  describe('getStatistics', () => {
    it('should successfully get group statistics', async () => {
      ...
      await groupController.getStatistics(mockRequest as Request, mockResponse as Response, mockNext);
