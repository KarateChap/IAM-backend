...
const MockedUserGroup = UserGroup as jest.MockedClass<typeof UserGroup>;
...
describe('UserGroupService', () => {
  ...
  describe('assignUsersToGroup', () => {
      ...
      const mockUsers = [
        {
          get: jest.fn((key) => {
            ...
            if (key === 'email') return 'user1@test.com';
        ...
        },
        {
          get: jest.fn((key) => {
            ...
            if (key === 'email') return 'user2@test.com';
            if (key === 'isActive') return true;
            return null;
          })
        }
    ...
    it('should throw BadRequestError if userIds is not an array', async () => {
      const groupId = 1;
      const userIds = 'not-an-array' as any;
  ...
  describe('getUserGroups', () => {
    it('should return groups for a user', async () => {
      ...
      const mockGroups = [
        {
          get: jest.fn((key) => {
            if (key === 'name') return 'Group 1';
            if (key === 'description') return 'Test Group 1';
            return null;
          })
        },
        {
          get: jest.fn((key) => {
            if (key === 'name') return 'Group 2';
            if (key === 'description') return 'Test Group 2';
            return null;
          })
        }
      ];
  ...
  describe('getActiveGroupUsers', () => {
    it('should return only active users for a group', async () => {
      ...
      const mockActiveUsers = [
        {
          get: jest.fn((key) => {
            if (key === 'username') return 'activeuser1';
            if (key === 'isActive') return true;
            return null;
          })
        }
