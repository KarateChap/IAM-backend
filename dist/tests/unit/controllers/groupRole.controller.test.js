...
const groupRole_controller_1 = require("../../../src/controllers/groupRole.controller");
...
describe('GroupRole Controller', () => {
    ...
    describe('assignRolesToGroup', () => {
        it('should successfully assign roles to group', async () => {
            ...
            await (0, groupRole_controller_1.assignRolesToGroup)(mockRequest, mockResponse, mockNext);
    ...
    describe('removeRolesFromGroup', () => {
        it('should successfully remove roles from group', async () => {
            ...
            mockAuditServiceInstance.logEvent.mockResolvedValue(undefined);
            await (0, groupRole_controller_1.removeRolesFromGroup)(mockRequest, mockResponse, mockNext);
    ...
    describe('getGroupRoles', () => {
        it('should successfully get group roles', async () => {
            ...
            await (0, groupRole_controller_1.getGroupRoles)(mockRequest, mockResponse, mockNext);
    ...
    describe('Error handling', () => {
        it('should format validation errors correctly', async () => {
            ...
            expect(validationError).toBeInstanceOf(errors_1.ValidationError);
