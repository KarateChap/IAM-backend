...
const role_controller_1 = __importDefault(require("../../../src/controllers/role.controller"));
const services_1 = require("../../../src/services");
// Mock dependencies
jest.mock('express-validator');
jest.mock('../../../src/services');
const mockValidationResult = express_validator_1.validationResult;
const mockRoleService = services_1.roleService;
...
describe('Role Controller', () => {
    ...
    beforeEach(() => {
        ...
        mockNext = jest.fn();
        roleController = new role_controller_1.default();
    ...
    describe('getAll', () => {
        it('should successfully get roles with default filters', async () => {
            ...
            await roleController.getAll(mockRequest, mockResponse, mockNext);
    ...
    describe('getById', () => {
        it('should successfully get role by id', async () => {
            ...
            await roleController.getById(mockRequest, mockResponse, mockNext);
    ...
    describe('create', () => {
        it('should successfully create a role', async () => {
            ...
            await roleController.create(mockRequest, mockResponse, mockNext);
    ...
    describe('update', () => {
        it('should successfully update a role', async () => {
            ...
            await roleController.update(mockRequest, mockResponse, mockNext);
    ...
    describe('delete', () => {
        it('should successfully delete a role', async () => {
            ...
            mockAuditService.logEvent.mockResolvedValue(undefined);
            await roleController.delete(mockRequest, mockResponse, mockNext);
            expect(mockRoleService.getRoleById).toHaveBeenCalledWith(1);
