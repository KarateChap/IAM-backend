...
const permission_controller_1 = __importDefault(require("../../../src/controllers/permission.controller"));
const services_1 = require("../../../src/services");
// Mock dependencies
jest.mock('express-validator');
jest.mock('../../../src/services');
const mockValidationResult = express_validator_1.validationResult;
const mockPermissionService = services_1.permissionService;
...
describe('Permission Controller', () => {
    ...
    beforeEach(() => {
        ...
        mockNext = jest.fn();
        permissionController = new permission_controller_1.default();
    ...
    describe('getAll', () => {
        it('should successfully get permissions with default filters', async () => {
            ...
            await permissionController.getAll(mockRequest, mockResponse, mockNext);
    ...
    describe('getById', () => {
        it('should successfully get permission by id', async () => {
            ...
            await permissionController.getById(mockRequest, mockResponse, mockNext);
    ...
    describe('create', () => {
        it('should successfully create a permission', async () => {
            ...
            await permissionController.create(mockRequest, mockResponse, mockNext);
    ...
    describe('update', () => {
        it('should successfully update a permission', async () => {
            ...
            await permissionController.update(mockRequest, mockResponse, mockNext);
    ...
    describe('delete', () => {
        it('should successfully delete a permission', async () => {
            ...
            mockAuditService.logEvent.mockResolvedValue(undefined);
            await permissionController.delete(mockRequest, mockResponse, mockNext);
            expect(mockPermissionService.getPermissionById).toHaveBeenCalledWith(1);
