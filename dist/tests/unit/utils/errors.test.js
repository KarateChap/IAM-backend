...
describe('Error Classes', () => {
    describe('AppError', () => {
        it('should create error with message and status code', () => {
            // Act
            const error = new errors_1.AppError('Test error', 500);
            // Assert
    ...
    describe('BadRequestError', () => {
        ...
        it('should create 400 error with custom message', () => {
            // Act
            const error = new errors_1.BadRequestError('Custom bad request');
            // Assert
    ...
    describe('ValidationError', () => {
        it('should create 422 error with message and details', () => {
            ...
            // Act
            const error = new errors_1.ValidationError('Validation failed', details);
            // Assert
    ...
    describe('Error inheritance', () => {
        it('should maintain proper inheritance chain', () => {
            ...
            // Assert
            expect(badRequest).toBeInstanceOf(errors_1.AppError);
            expect(badRequest).toBeInstanceOf(Error);
            expect(unauthorized).toBeInstanceOf(errors_1.AppError);
            expect(unauthorized).toBeInstanceOf(Error);
            expect(notFound).toBeInstanceOf(errors_1.AppError);
